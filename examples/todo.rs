...
/// A simple component displaying a checkbox
#[derive(Debug)]
pub struct Checkbox {
...
impl Component for Todo {
    ...
    fn view(&self) -> Layout {
        ...
        Layout::row([
            Item::fixed(checkbox_width)(Checkbox::with(CheckboxProperties {
                style: content_style,
                checked,
            })),
            Item::auto(todo_component),
        ])
    }
}
...
impl Component for TodoMvc {
    ...
    fn view(&self) -> Layout {
        ...
        // Title component
        let title = Item::fixed(LOGO.lines().count() + 1)(Text::with_key(
            "title",
            TextProperties::new()
                .content(LOGO)
                .style(theme.checked)
        ...
        let todo_items = Item::auto(Select::with_key(
            "select",
            SelectProperties {
        ...
        let status_bar = Item::fixed(1)(Text::with_key(
            "status-bar",
            TextProperties::new()
                .content(format!(
